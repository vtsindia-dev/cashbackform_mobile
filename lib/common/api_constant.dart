class ApiUrl {
  ...
  // Enquiries
  static const String materialEnquiry = "$baseUrl/api/v2/material_enquriy";
  ...
  static const String contactUs = "$baseUrl/api/v2/contact_us";
  static const String aboutUs = "$baseUrl/api/v2/about_us";
