class ApiUrl {
  ...
  static const String myServicesEnquiryList = '$baseUrl/api/v2/my_services_enquiry_list';
  static const String myMaterialEnquiryList = '$baseUrl/api/v2/my_material_enquiry_list';
