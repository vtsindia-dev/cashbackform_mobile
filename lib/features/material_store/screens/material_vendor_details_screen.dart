...
class MaterialVendorDetailScreen extends StatefulWidget {
  ...
  @override
  State<MaterialVendorDetailScreen> createState() => _MaterialVendorDetailScreenState();
}

class _MaterialVendorDetailScreenState extends State<MaterialVendorDetailScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<MaterialController>(
      builder: (controller) {
        ...
        final brandList = controller.brandDetailList;
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            rating.toStringAsFixed(1),
            style: const TextStyle(
                fontSize: 12, fontWeight: FontWeight.w700, color: Color(0xFFB45309)),
          ),
        ],
      ),
    );
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: const BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(color: Color(0x30E8A020), blurRadius: 8, offset: Offset(0, 3))
          ],
        ),
        child: Center(
  ...
  Widget _buildServicesTab(vendor.Vendor vendor) {
    ...
    if (services.isEmpty)
      return _buildEmptyState('No services listed', Icons.build_outlined);
    return ListView.separated(
      padding: const EdgeInsets.all(12),
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(review.review,
                      style: const TextStyle(
                          fontSize: 12.5, color: _muted, height: 1.6)),
                ],
              ),
            ).animate(
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            height: 64,
            decoration:
            const BoxDecoration(color: _goldLight, shape: BoxShape.circle),
