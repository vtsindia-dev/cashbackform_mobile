...
// Alternative: Update just the widget to work with existing model
  ...
  Widget _buildPlotCard(SyndicateBuyingDetail detail) {
    final canCancel = detail.canCancel;
    final isCancelled = detail.isCancelled;
    final hasRefund = detail.hasRefund;
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                4.h.verticalSpace,
                                Text(
                                  '₹${detail.refundAmountValue.toStringAsFixed(2)}',
                                  style: TextStyle(
                                    fontSize: 18.sp,
                                    fontWeight: FontWeight.w900,
                                    color: _neutralDark,
...
// Helper method to get color based on transaction status
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                'This will cancel your investment in Plot #${detail.unit}. The amount will be refunded to your original payment method.',
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontSize: 14.sp,
                  color: Colors.grey.shade600,
  ...
  void _processPlotCancellation(SyndicateBuyingDetail detail) async {
    ...
    try {
      // Call the cancellation API with the plot detail ID
