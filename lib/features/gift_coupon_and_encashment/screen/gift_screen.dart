...
class _GiftScreenState extends State<GiftScreen> with TickerProviderStateMixin {
  ...
  void _fetchGstValue() => setState(() {
    gstValue =
        dashboardController.businessSettings.value?.couponServiceCharge ?? 0;
    minCouponValAmount =
        dashboardController.businessSettings.value?.minCouponVal ?? 0;
    maxCouponValAmount =
        dashboardController.businessSettings.value?.maxCouponVal ?? 0;
    walletAmount =
        double.tryParse(
  ...
  Future<void> _onPaySuccess(PaymentSuccessResponse r) async {
    try {
      ...
      await giftController.giftVouchersBuyPostApi(
        ...
        transactionDetails: r.paymentId ?? '',
        isFromWallet: false,
      );
      ...
      Get.off(
        () => PaymentStatusScreen(isSuccess: false, paymentId: r.paymentId),
      );
    } finally {
  ...
  void _onPayError(PaymentFailureResponse r) => Get.to(
    () => PaymentStatusScreen(isSuccess: false, errorMessage: r.message),
  );

  void _onExternalWallet(ExternalWalletResponse r) => ScaffoldMessenger.of(
    context,
  ...
  Future<void> _onPurchase() async {
    if (!_isValidAmount) {
      _toast(
        'Amount must be ${_fmt(minCouponValAmount)} – ${_fmt(maxCouponValAmount)}',
        err: true,
      );
      return;
    }
    ...
    if (_isWalletTab) {
      ...
      _openCheckout(totalAmount.toStringAsFixed(2));
    }
  }
      ...
      background: AnimatedBuilder(
        ...
        builder: (_, __) => Container(
          ...
          child: Stack(
            children: [
              Positioned(
                top: -35 + (_floatAnim.value * 10),
                right: -25,
                child: _orb(200, Colors.white, 0.055),
              ),
              Positioned(
                top: 30 - (_floatAnim.value * 8),
                right: 45,
                child: _orb(90, AppColor.orange, 0.20),
              ),
              Positioned(
                bottom: -15 + (_floatAnim.value * 6),
                left: 20,
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: AppColor.orange.withValues(alpha: 0.22),
                        borderRadius: BorderRadius.circular(7),
                        border: Border.all(
                          color: AppColor.orange.withValues(alpha: 0.45),
                        ),
                      ),
                      child: const Text(
                        '✦  GIFT VOUCHERS',
                    ...
                    Text(
                      'Buy, share & manage gift vouchers instantly',
                      style: TextStyle(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: active
              ? [
                  BoxShadow(
                    color: AppColor.primary.withValues(alpha: 0.42),
                    blurRadius: 18,
                    offset: const Offset(0, 5),
                  ),
                ]
    ...
    builder: (_, __) => Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            Color.lerp(
              const Color(0xFF3A5820),
              AppColor.primary,
              _floatAnim.value,
            )!,
            Color.lerp(
              const Color(0xFF5A8030),
              const Color(0xFF7CA44C),
              _floatAnim.value,
            )!,
          ],
          begin: Alignment.topLeft,
      ...
      child: Stack(
        children: [
          Positioned(
            top: -22,
            right: -12,
            child: _orb(120, Colors.white, 0.06),
          ),
          Positioned(
            bottom: -25,
            left: 50,
            child: _orb(100, AppColor.orange, 0.10),
          ),
          Positioned(
            top: 8,
            right: 8,
            child: _orb(42, AppColor.primarylite, 0.18),
          ),
          Row(
            children: [
              Expanded(
  ...
  Widget _warningBanner() => Container(
    ...
    decoration: BoxDecoration(
      ...
      border: Border.all(
        color: AppColor.orange.withValues(alpha: 0.4),
        width: 1.5,
      ),
    ),
    child: Row(
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            color: AppColor.orange.withValues(alpha: 0.14),
            shape: BoxShape.circle,
          ),
          child: const Icon(
            ...
            Expanded(
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: '0',
                  hintStyle: TextStyle(
                    color: AppColor.grey.withValues(alpha: 0.45),
                  ),
                ),
              ),
            ),
        ...
        return GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: sel ? AppColor.orange : const Color(0xFFD8D4C8),
                width: 1.5,
              ),
              boxShadow: sel
                  ? [
                      BoxShadow(
                        color: AppColor.orange.withValues(alpha: 0.36),
                        blurRadius: 14,
                        offset: const Offset(0, 5),
                      ),
                    ]
        ...
        boxShadow: [
          BoxShadow(
            color: AppColor.primary.withValues(
              alpha: 0.09 + _floatAnim.value * 0.04,
            ),
            blurRadius: 20,
            offset: const Offset(0, 6),
          ),
      ...
      children: [
        ...
        Text(
          ...
          style: TextStyle(
            ...
            fontWeight: FontWeight.w800,
            color:
                highlight ?? (isTotal ? AppColor.primary : AppColor.textMain),
  ...
  Widget _ctaButton() => GetBuilder<GiftController>(
    builder: (ctrl) {
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            boxShadow: disabled
                ...
                : [
                    BoxShadow(
                      color: AppColor.primary.withValues(alpha: 0.44),
                      blurRadius: 26,
  ...
  Widget _sectionHeader() => GetBuilder<GiftController>(
    builder: (ctrl) => Row(
      children: [
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                '${ctrl.couponList.length} coupons purchased',
  ...
  Widget _couponList() => GetBuilder<GiftController>(
    builder: (ctrl) {
                ...
                child: Stack(
                  children: [
                    Positioned(
                      top: -22,
                      right: -12,
                      child: _orb(110, Colors.white, 0.06),
                    ),
                    Positioned(
                      bottom: -28,
                      left: 60,
                      child: _orb(85, Colors.white, 0.04),
                    ),
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: isActive
                            ? AppColor.primary.withValues(alpha: 0.055)
  ...
  Widget _datePill(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        color: (accent && active)
            ? AppColor.orange.withValues(alpha: 0.07)
            : const Color(0xFFF5F5F0),
        borderRadius: BorderRadius.circular(11),
        border: Border.all(
          color: (accent && active)
              ? AppColor.orange.withValues(alpha: 0.28)
      ...
      child: Row(
        children: [
          Icon(
            icon,
            size: 12,
            color: (accent && active) ? AppColor.orange : AppColor.grey,
          ),
          const SizedBox(width: 7),
          Expanded(
            child: Column(
    ...
    child: Padding(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 4),
          const Text(
            'Purchase your first gift coupon above',
  ...
  void _downloadVoucher({String? id}) async {
    if (id == null) return;
    final uri = Uri.parse(
      '${ApiUrl.baseUrl}/api/v2/coupon-invoice-download/$id',
    );
  ...
  Map<String, dynamic> _statusInfo(int status, String? expiry) {
    ...
    switch (status) {
      case 0:
        return {'label': 'Active', 'dot': const Color(0xFF81C784)};
      case 1:
        return {'label': 'Used', 'dot': AppColor.grey};
      default:
        return {'label': 'Expired', 'dot': AppColor.red};
    }
  }
        ...
        children: [
          ...
          Center(
            child: CustomPaint(
              ...
              painter: _DashPainter(color: lineColor.withValues(alpha: 0.3)),
            ),
          ),
        ],
      ),
