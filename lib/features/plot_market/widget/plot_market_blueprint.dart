...
class PlotMarketBlueprint extends StatefulWidget {
  const PlotMarketBlueprint({super.key});
  @override
  State<PlotMarketBlueprint> createState() => _PlotMarketBlueprintState();
}

class _PlotMarketBlueprintState extends State<PlotMarketBlueprint> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Obx(() {
        final String? bluePrintUrl = controller.marketDetail.value?.plotImage;
